...
{
    /// <summary>
    /// The view model for main city weather control
    /// </summary>
    public class CityWeatherMainViewModel
    { 
        ...
        /// <summary>
        /// Indicates that we couldn't find any data to show
        /// </summary>
        public bool NoDataFound { get; set; }

        /// <summary>
        /// The name of a city that user has selected
        /// </summary>
        ...
        public CityWeatherMainViewModel(string city)
        {
            // Get selected city name that weather will be displayed for
            CityName = city;
